 ...
 * @private
 */
google.bookmarkbubble.Bubble.prototype.IMAGE_ARROW_DATA_URL_ = 'img/down-arrow.png';
 ...
 * @private
 */
google.bookmarkbubble.Bubble.prototype.IMAGE_CLOSE_DATA_URL_ = 'img/close-icon.png';
...
google.bookmarkbubble.Bubble.prototype.IMAGE_SAFARI_FORWARD_DATA_URL_ = 'img/forward.png';
 ...
 * @private
 */
google.bookmarkbubble.Bubble.prototype.MOBILE_SAFARI_USERAGENT_REGEX_ = /iPhone|iPod|iPad/; // /iPhone|iPod|iPad|Android|BlackBerry|PlayBook/;
...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  bubbleInner.id = "bookmark-bubble-inner";
  if (this.getAndroidVersion_() >= this.getVersion_(3, 0)) {
    bubbleInner.style.margin = '0 0 0 ' +(window.innerWidth - 357) + 'px';
  } else {
    bubbleInner.style.margin = isIpad ? '0 0 0 15px' : '0 auto';
  }
  ...
  icon.id = "bookmark-bubble-icon";
  icon.style.background =
      '#fff url(' + this.getIconUrl_() + ') no-repeat 0 0';
  bubbleInner.insertBefore(icon, bubbleInner.firstChild);
	
  var arrow = document.createElement('div');
  arrow.id = "bookmark-bubble-arrow";
  arrow.style.background = 'url(' + this.IMAGE_ARROW_DATA_URL_ + ') no-repeat 3px 0';
  if (isIpad || isPlayBook) {
    arrow.style.WebkitTransform = 'rotate(180deg)';
    arrow.style.top = '-19px';
    arrow.style.left = '131px';
    ...
    arrow.style.left = '148px';
  }
  bubbleInner.appendChild(arrow);

  var close = document.createElement('a');
  close.id = "bookmark-bubble-close";
  ...
  clear.id = "bookmark-bubble-clear";
  bubbleInner.appendChild(clear);
